export default function Slider() {
    return (
      <>
<header className="py-0" id="landing-head">
      ...
      <div className="col-xxl-5">
        ...
        <div className="text-center text-xxl-start">
          ...
          <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
            <a
              className="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder to-div-link"
              href="#landing-about"
            >
              Hakkımda
            </a>
      ...
      <div className="col-xxl-7">
        ...
        <div className="d-flex justify-content-center mt-5 mt-xxl-0">
          <div className="profile bg-gradient-primary-to-secondary">
            ...
            <img className="profile-img" src="src/assets/img/muharrem-etdoger.png" alt="Muharrem Etdöğer" />
